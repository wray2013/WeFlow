...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private OnTouchUpFinishListener onTouchUpFinishListener;
	
	public void setOnTouchUpFinishListener(OnTouchUpFinishListener l) {
		onTouchUpFinishListener = l;
	}
	
	public interface OnTouchUpFinishListener {
	...
	public final boolean onTouchEvent(MotionEvent event) {
		...
		switch (event.getAction()) {
			...
			case MotionEvent.ACTION_UP: {
				if (onTouchUpFinishListener != null) {
					onTouchUpFinishListener.onTouchUpFinish();
				}
				if (mIsBeingDragged) {
					mIsBeingDragged = false;
