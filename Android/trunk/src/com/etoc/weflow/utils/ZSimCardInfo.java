...
public final class ZSimCardInfo {
	...
	private static TelephonyManager telephonyManager = (TelephonyManager) WeFlowApplication.getAppInstance().getSystemService(Context.TELEPHONY_SERVICE);
	private static WifiManager wifiMgr  = (WifiManager) WeFlowApplication.getAppInstance().getSystemService(Context.WIFI_SERVICE);
