...
public class MobileFlowActivity2 extends TitleRootActivity {
			...
			public void onClick(DialogInterface arg0, int arg1) {
				...
				if(PromptDialog.checkPhoneNum(exchangeDialog.getContext())) {
					if (accountInfo != null && accountInfo.getUserid() != null) {
						...
						startActivity(new Intent(MobileFlowActivity2.this, LoginActivity.class));
					}
				} else {
					Toast.makeText(MobileFlowActivity2.this, "请输入有效手机号", Toast.LENGTH_SHORT).show();
				}
