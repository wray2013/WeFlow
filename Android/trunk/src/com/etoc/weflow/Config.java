...
public class Config {
	 ...
	 *  生产环境，勿启用
	 **/
	public static final String SERVER_URL    = "http://113.57.243.148:81";//"http://113.57.180.175:8090";//"http://123.56.104.49:7085";//"http://61.51.83.194:9080";//"http://113.57.243.18:8088/base-web/dg";
	
	public static final String WEBSERVER_URL = SERVER_URL;
	
	public static final String HOMEPAGE_URL = WEBSERVER_URL + "/export/webpage/home.html";
	public static final String BANKPAGE_URL = WEBSERVER_URL + "/export/webpage/bank.html";
	public static final String ABOUTPAGE_URL= WEBSERVER_URL + "/export/webpage/about.html";
	 ...
	 *  外网测试环境，用于上线前调试
	 */
//	public static final String SERVER_URL    = "http://xxx/vs/api"; 
...
//	public static final String SERVER_URL    = "http://xxx/vs/api"; 
	...
	public static final String DOWNLOAD_FOLDER = Environment.getExternalStorageDirectory()
			+ "/EToCDownload/";
	public static final String SD_STORAGE_ROOT = "/.weflow"; //不包括sdcard的路径
	
	public static final String DAY_IN_MI = "15811200000";
	
	public static final String HOME_PAGE = "http://www.songliuliang.com";
	
	public static final String[] BANNER_IMAGES = new String[] {
		"http://www.songliuliang.com/woapp/jsp/images/banner1.jpg",
		"http://www.songliuliang.com/woapp/jsp/images/banner2.jpg"
	};
