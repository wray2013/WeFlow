 ...
 *
 */
public final class VMobileInfo {

	private static TelephonyManager telephonyManager = VSystemService.getTelephonyManager();
	private static WifiManager wifiMgr  = VSystemService.getWifiManager();
