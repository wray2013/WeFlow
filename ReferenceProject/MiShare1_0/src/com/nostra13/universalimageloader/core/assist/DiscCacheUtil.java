...
public final class DiscCacheUtil {
	...
	public static File findInCache(String imageUri, String uid, DiscCacheAware discCache) {
		File image = discCache.get(imageUri, uid);
	 ...
	 */
	public static boolean removeFromCache(String imageUri, String uid, DiscCacheAware discCache) {
		File image = discCache.get(imageUri, uid);
		return image.delete();
	}
}
