...
public class TWFriendsAPI extends BasicAPI {
 
	private String friendsMutualListUrl=apiBaseUrl+"/friends/mutual_list";
     ...
     */
    public TWFriendsAPI(String OAuthVersion) {
        super(OAuthVersion);
    }
     ...
     */
    public TWFriendsAPI(String OAuthVersion, QHttpClient qHttpClient) {
	 ...
	 */
	public String fanslist(OAuthV2 oAuth, String format, String reqnum,
	 ...
	 */
	public String idollist(OAuthV2 oAuth, String format, String reqnum,
     ...
     * @see <a href="http://wiki.open.t.qq.com/index.php/%E5%B8%90%E6%88%B7%E7%9B%B8%E5%85%B3/%E6%88%91%E6%94%B6%E5%90%AC%E7%9A%84%E4%BA%BA%E5%88%97%E8%A1%A8">腾讯微博开放平台上关于此条API的文档</a>
	 */
	public String mutualList(OAuthV2 oAuth, String name, String format, String reqnum,
			String startindex, String install) throws Exception {  
		QArrayList paramsList = new QArrayList();
		...
		return requestAPI.getResource(friendsMutualListUrl,
				paramsList, oAuth);
	}
	 ...
	 */
	public String add(OAuthV2 oAuth, String format, String name,String fopenids ) throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", format));
		paramsList.add(new BasicNameValuePair("name", name));
	 ...
	 */
	public String del(OAuthV2 oAuth, String format, String name,String fopenid) throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", format));
		paramsList.add(new BasicNameValuePair("name", name));
	 ...
	 */
	public String check(OAuthV2 oAuth, String format, String names,String fopenids,String flag) throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", format));
     ...
     */
    public String userFanslist(OAuthV2 oAuth, String format, String reqnum,
	 ...
	 */
	public String userIdollist(OAuthV2 oAuth, String format, String reqnum,
	 ...
	 */
	public String userSpeciallist(OAuthV2 oAuth, String format, String reqnum,
			String startindex,String name, String fopenid,String install) throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", format));
		paramsList.add(new BasicNameValuePair("reqnum", reqnum));
	 ...
	 */
	public String fanslistS(OAuthV2 oAuth, String format, String reqnum,
			String startindex,String install) throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", format));
		paramsList.add(new BasicNameValuePair("reqnum", reqnum));
