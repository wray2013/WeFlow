...
public class TWUserAPI  extends BasicAPI{
     ...
     */
    public TWUserAPI(String OAuthVersion) {
        super(OAuthVersion);
    }
     ...
     */
    public TWUserAPI(String OAuthVersion, QHttpClient qHttpClient) {
	 ...
	 */
	public String info(OAuthV2 oAuth, String format) throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", format));
		//paramsList.add(new BasicNameValuePair("oauth_consumer_key", format));
	 ...
	 */
	public String otherInfo(OAuthV2 oAuth, String format, String name, String fopenid)
			throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", format));
	 ...
	 */
	public String infos(OAuthV2 oAuth, String format, String names ,String fopenids
			)
			throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", format));
