...
/*		QArrayList paramsList = new QArrayList();
	 ...
	 * 
	 * http://wiki.dev.renren.com/wiki/V2/comment/put
	 * 
	 * @param id 日志id
	 * @param uid 用户的ID
	 * @param content 评论的内容
	 */
	public String reply(OAuthV2 oAuth, long entryOwnerId, long entryId, String content) throws Exception{
/*		QArrayList paramsList = new QArrayList();
		...
		//params.add("targetUserId", pageNumber);
		params.add("commentType", "PHOTO");
		params.add("entryOwnerId", entryOwnerId);
		params.add("entryId", entryId);

		
		String ret = requestAPI.getResource("https://api.renren.com/v2/comment/put", params, oAuth);
