...
public class Prompt {
	...
	public static boolean checkMiShareNo(String num) 
	{  
		try{            
...
/*	public static void Alert(Context context, String content){
	...
	public static void Alert(Context context, String content){
		...
		Intent resultIntent = new Intent(context, LookLookActivity.class);
		...
		stackBuilder.addParentStack(LookLookActivity.class);
	...
	public static void Dialog(Context context, boolean hasCancel, String title, String msg, DialogInterface.OnClickListener listenerPositive){
		try{
			...
			if(hasCancel){
				...
				.create();
				x_dialog.setCanceledOnTouchOutside(true);
				x_dialog.show();
			}else{
				x_dialog = new Xdialog.Builder(context)
				.setTitle(title)
	...
	public static void Dialog(Context context, boolean hasCancel, String title, String msg, DialogInterface.OnClickListener listenerPositive, int resPositive, int resNegative){
		try{
			Xdialog x_dialog = null;
			...
			if(hasCancel){
				...
				.setTitle(title)
				.setMessage(msg)
				.setPositiveButton(resPositive, listenerPositive)
				.setNegativeButton(resNegative, null)
				.create();
				x_dialog.setCanceledOnTouchOutside(true);
				x_dialog.show();
			}else{
	...
	public static void Dialog(Context context, boolean hasCancel, String title, Spanned msg, DialogInterface.OnClickListener listenerPositive, int resPositive, int resNegative){
		try{
			Xdialog x_dialog = null;
