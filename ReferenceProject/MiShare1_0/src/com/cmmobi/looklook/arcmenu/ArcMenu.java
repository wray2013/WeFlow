...
package com.cmmobi.looklook.arcmenu;
...
//				Log.d("addItem", "onLongClick");
//				return true;
//			}
//		});
//    	item.setOnTouchListener(getItemTouchListener(new OnTouchListener() {
//			
//			@Override
//			public boolean onTouch(View v, MotionEvent event) {
//				Log.d("addItem", "onTouch");
//				return false;
//			}
//		}));
    }
    
    public void addItem(View item, OnClickListener listener,OnLongClickListener longClickListener,OnTouchListener touchListener) {
        mArcLayout.addView(item);
        item.setOnClickListener(getItemClickListener(listener));
    ...
    public OnTouchListener getItemTouchListener(final OnTouchListener listener) {
    	return new OnTouchListener() {

			@Override
    		public boolean onTouch(final View viewClicked,MotionEvent event) {
    			...
    			if (listener != null) {
    				listener.onTouch(viewClicked, event);
    			}
    			return false;
    		}
    	};
