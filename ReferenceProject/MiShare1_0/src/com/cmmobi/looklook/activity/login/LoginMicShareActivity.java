...
public class LoginMicShareActivity extends ZActivity {
	...
	public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_login_micshare);
			...
			try {
				...
				if(obj!=null){
					...
					if(obj.status.equals("0")){
						...
						//Prompt.Dialog(LoginMicShareActivity.this, false, "提醒", ser_ret , null);
			    	...
			    	//Prompt.Dialog(LoginMicShareActivity.this, false, "提醒", "网络超时", null);
				}
