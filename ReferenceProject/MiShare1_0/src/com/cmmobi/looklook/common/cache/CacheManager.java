...
public class CacheManager{
	...
	private transient EntryWeigher<String, CacheResult> memoryUsageWeigher = new EntryWeigher<String, CacheResult>() {
	...
	private transient EvictionListener<String, CacheResult> listener = new EvictionListener<String, CacheResult>() {
		  @Override 
