...
public class FriendListAdapter extends ArrayAdapter<GsonResponse2.User> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.del_row_list_friend, null);
		...
		holder.head.setImageUrl(handler, R.drawable.del_zone_1, ActiveAccount.getInstance(context).getUID(), 1, item.portraiturl, true);
