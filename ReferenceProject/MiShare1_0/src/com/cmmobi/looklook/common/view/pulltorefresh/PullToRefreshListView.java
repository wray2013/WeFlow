...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	protected void onRefreshing(final boolean doScroll) {
		...
		listViewLoadingView.setVisibility(isPullDownSilenceEnabled() ? View.GONE : View.VISIBLE);
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
			...
			final boolean returnValue = super.overScrollBy(deltaX, deltaY, scrollX, scrollY, scrollRangeX,
					scrollRangeY, maxOverScrollX, maxOverScrollY/*mMaxYOverscrollDistance*/, isTouchEvent);
...
//				}
		...
		public boolean onInterceptTouchEvent(MotionEvent arg0)
		{
			if (multListener == null || !multListener.isIntercept())
			{
				try
				{
					if(multListener != null && multListener.isForbidMove()) {
						...
						Log.d("Touch","velocityX = " + velocityX + " velocityY = " + velocityY);
						if (Math.abs(velocityY) > Math.abs(velocityX) || (velocityY == 0 && velocityX == 0)) {
							return false;
						}
					} 
