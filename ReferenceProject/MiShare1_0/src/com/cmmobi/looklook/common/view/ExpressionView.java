...
//	private static HashMap<String, Integer> EXPHM = new HashMap<String, Integer>();
	...
	public ExpressionView(Activity activity, EditText editText) {
		...
		View tab3 = inflater.inflate(R.layout.del_include_expression_tab3, null);
		...
		popupWindow_view = activity.getLayoutInflater().inflate(
				R.layout.del_activity_homepage_biaoqing_fagndajing_popupwindow,
				null, false);
	...
	public void replacedExpressions(String expressionText, TextView tv) {
		...
		if (list != null && list.size() > 0) {
			...
			for (int i = 0; i < len; i++) {
				...
				tv.append(Html.fromHtml("<img src='" + FriendsExpressionView.EXPHM.get(exp) + "'/>",
						imageGetter, null));
				expStart = expEnd;
			}
...
//				Pattern pattern = Pattern.compile("\\[[\\u4e00-\\u9fa5]*?\\]");
	...
	public void onPageSelected(int arg0) {
		switch (arg0) {
		case 0:
			ivPageDots[0].setImageResource(R.drawable.del_biaoqing_fanye_2);
			ivPageDots[1].setImageResource(R.drawable.del_biaoqing_fanye_1);
			ivPageDots[2].setImageResource(R.drawable.del_biaoqing_fanye_1);
			break;
		case 1:
			ivPageDots[0].setImageResource(R.drawable.del_biaoqing_fanye_1);
			ivPageDots[1].setImageResource(R.drawable.del_biaoqing_fanye_2);
			ivPageDots[2].setImageResource(R.drawable.del_biaoqing_fanye_1);
			break;
		case 2:
			ivPageDots[0].setImageResource(R.drawable.del_biaoqing_fanye_1);
