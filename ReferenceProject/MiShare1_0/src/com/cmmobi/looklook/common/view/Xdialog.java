...
//	private Animation loopAnim;
	private void init(){
		...
		vShuxian=view.findViewById(R.id.v_shuxian);
...
//	    p.width = (int) (d.getWidth() * 1);    //宽度设置为屏幕的1.0   
	    /*startAnim=AnimationUtils.loadAnimation(getContext(), R.anim.del_anim_dialog_fade_in);
	    ...
	    loopAnim=AnimationUtils.loadAnimation(getContext(), R.anim.del_anim_dialog_loop);
	    endAnim=AnimationUtils.loadAnimation(getContext(), R.anim.del_anim_dialog_fade_out);
...
//			xdialog.tvTitle.setText(res);
		...
		public Builder setMessage(Spanned msg){
			xdialog.tvContent.setText(msg);
			return this;
		}
		
		public Builder setMessage(SpannableStringBuilder style){
			xdialog.tvContent.setText(style);
			return this;
		}
		...
		public Xdialog create(){
			if(xdialog.Vcancel.getVisibility()==View.GONE){
				xdialog.vok.setBackgroundResource(R.drawable.btn_xdialog);
				xdialog.vShuxian.setVisibility(View.GONE);
			}
			return xdialog;
		}
...
/*public class Xdialog extends Dialog implements android.view.View.OnClickListener,AnimationListener {
	...
	private void init(){
		inflater=LayoutInflater.from(getContext());
		view=inflater.inflate(R.layout.del_cmmobi_dialog, null);
		setContentView(view);
		btnOK=(Button) view.findViewById(R.id.btn_ok);
		btnCancel=(Button) view.findViewById(R.id.btn_cancel);
		vok=view.findViewById(R.id.ll_ok);
