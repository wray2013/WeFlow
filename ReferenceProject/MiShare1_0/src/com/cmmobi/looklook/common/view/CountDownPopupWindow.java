...
public class CountDownPopupWindow {
	...
	public CountDownPopupWindow(Activity act){
		this.act = act;
	}
	...
	public void show() {
		...
		popupWindow_view = act.getLayoutInflater().inflate(
				R.layout.short_recorder_countdown_popupwindow, null,
				false);
		vContainer=popupWindow_view.findViewById(R.id.fl_container);
		countdownTv = (TextView) popupWindow_view.findViewById(R.id.tv_short_rec_countdown);
		ivCountDown = (ImageView) popupWindow_view.findViewById(R.id.iv_short_rec_countdown);
		// 创建PopupWindow实例
		timeShow = new PopupWindow(popupWindow_view,  ViewGroup.LayoutParams.MATCH_PARENT, 
	...
	public boolean isShowing(){
		return (timeShow != null && timeShow.isShowing());
	}
