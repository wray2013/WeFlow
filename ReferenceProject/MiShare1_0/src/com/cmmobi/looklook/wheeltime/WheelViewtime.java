...
public class WheelViewtime extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0x11007aff,
			0x06007aff, 0x03007aff };
	...
	public static final int DEF_VISIBLE_ITEMS = 7;

	// Wheel Values
	private WheelAdaptertime adapter = null;
	...
	// Listeners
	private List<OnWheelChangedListenertime> changingListeners = new LinkedList<OnWheelChangedListenertime>();
	private List<OnWheelScrollListenertime> scrollingListeners = new LinkedList<OnWheelScrollListenertime>();
	 ...
	 * @return the adapter
	 */
	public WheelAdaptertime getAdapter() {
		return adapter;
	}
	 ...
	 */
	public void setAdapter(WheelAdaptertime adapter) {
	 ...
	 *            the listener
	 */
	public void addChangingListener(OnWheelChangedListenertime listener) {
	 ...
	 *            the listener
	 */
	public void removeChangingListener(OnWheelChangedListenertime listener) {
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		for (OnWheelChangedListenertime listener : changingListeners) {
	 ...
	 *            the listener
	 */
	public void addScrollingListener(OnWheelScrollListenertime listener) {
	 ...
	 *            the listener
	 */
	public void removeScrollingListener(OnWheelScrollListenertime listener) {
	...
	protected void notifyScrollingListenersAboutStart() {
		for (OnWheelScrollListenertime listener : scrollingListeners) {
	...
	private int getMaxTextLength() {
		WheelAdaptertime adapter = getAdapter();
		if (adapter == null) {
			return 0;
		}
...
//		Log.d("=AAA=","pos = " + pos + " currentItem = " + currentItem);
		if (pos != currentItem) {
