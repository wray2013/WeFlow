...
//		info.downfiles = new ArrayList<MediaValue>();
	...
	public boolean handleMessage(Message msg) {
		...
		case Requester2.RESPONSE_TYPE_ADD_COLLECT_DIARY:
			// 收藏的响应
			GsonResponse2.addCollectDiaryResponse response = (GsonResponse2.addCollectDiaryResponse) msg.obj;
			if (msg.obj != null) {
				if (response == null) {
...
//							ZThread.sleep(5);
	...
	private void updateMediaMapping(File file, MediaFile mediafile) {
		...
		if (mediaValue != null) {
			Log.d("==WR==", "download mappingKey " + mediaValue.url + " path = " + mediaValue.path);
			mediaValue.Belong = 1;
