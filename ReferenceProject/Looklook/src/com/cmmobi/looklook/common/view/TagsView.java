...
public class TagsView extends LinearLayout {
	...
	private void init(Context context){
		...
		View v=inflater.inflate(R.layout.include_tags, null);
	...
	public void loadTags(DiaryManager diaryManager,boolean isIncludeSaveBox){
