...
public class WeiboResponse{
	...
	public class sinComment{
		String created_at; //Wed Jun 01 00:50:25 +0800 2011
		long id; //12438492184
		String text; //love your work.......
		String source; //
		String mid; //"202110601896455629"
		sinaUser user;
		sinaStatus status;
	}
	...
	public class TencentCommentInfo{
		...
		String geo; //"",
		String head; //:"http:\/\/app.qlogo.cn\/mbloghead\/e69cfcc231febd52384a",
		String https_head; //:"https:\/\/app.qlogo.cn\/mbloghead\/e69cfcc231febd52384a",
		String id; //:"119392075083098",
		Object image; //:null,
		int isrealname; //:2,
		int isvip; //:0,
		String jing; //"0",
		...
		Object source; //:{},
		int status; //0,
		String text; //"好久不见||@dscds555: 伟哥",
		String timestamp; //:1350017027,
		int type; //:7,
		Object video; //:null,
		String wei; //0
	}
...
/*		public long uid; //int	表示用户id
	...
	public class RWComment{
		long id; //评论的ID
		CommentType commentType; //评论的类型
		long entryId; //被评论对象的ID
		long entryOwnerId; //评论对象所有者的ID
		long authorId; //评论者的ID
