 ...
 * @author zhangwei
 */
public class NearbyVedioListView extends AbsRefreshView<nearVideoItem[]> {
	
	public NearbyVedioListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	
	public NearbyVedioListView(Context context) {
		super(context);
	}

	protected RelativeLayout relativeLayout;
	@Override
	protected void initContent(nearVideoItem[] items) {
	...
	@Override
	protected void addView(nearVideoItem[] items) {
