 ...
 * @author zhangwei
 */
public class NearbyDiaryListView extends AbsRefreshView<MyDiary[]> {
	
	public NearbyDiaryListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	
	public NearbyDiaryListView(Context context) {
		super(context);
	}
