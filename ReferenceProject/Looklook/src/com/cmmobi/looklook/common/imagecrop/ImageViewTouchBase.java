...
abstract class ImageViewTouchBase extends ImageView {
    ...
    protected void onLayout(boolean changed, int left, int top, int right,
        ...
        Log.d(TAG,"ImageViewToBase onLayout out");
    }
    ...
    public void setImageRotateBitmapResetBase(final RotateBitmap bitmap,
        ...
        Log.d(TAG,"setImageRotateBitmapResetBase in viewWidth = " + viewWidth);
...
//    	    setLayerType(View.LAYER_TYPE_SOFTWARE, null);
    		try {
    		    ...
    		    setLayerTypeMethod.invoke(this, new Object[] {0x01, null});
