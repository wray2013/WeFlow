...
public class PositionListAdapter extends ArrayAdapter<String>{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (checkedPosition != position) {
			holder.imgView.setImageResource(R.drawable.xuanzhong_1);
		} else {
			holder.imgView.setImageResource(R.drawable.xuanzhong_2);
		}

		holder.posText.setText(positions.get(position));
		holder.position = position;
