...
//			holder.rlDiaryItem = (RelativeLayout) convertView.findViewById(R.id.rl_row_list_diary_item);
    ...
    private String getCoverImage(int type, diaryAttach[] attachs) {
    	...
    	for(int i = 0; i < attachList.size(); i++) {
    		...
    		case 3: //图片
				...
				Log.d(TAG, "Nearby List show_width=" + show_width);
				Log.d(TAG, "Nearby List show_heigh=" + show_heigh);
