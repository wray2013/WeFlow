...
public final class BackgroundDownloader {
	...
	public BackgroundDownloader(PrivateCommonMessage message, String url, File file, int mediaType) {
		...
		this.mBroadcastReceiver = new BroadcastReceiver() {
			...
			public void onReceive(Context context, Intent intent) {
				...
				if(HomeActivity.ACTION_HOMEACTIVITY_EXIT.equals(action)){
	...
	public boolean start() {
		...
		if (b) {
			...
			thread.start();
			ZApplication.getInstance().registerReceiver(mBroadcastReceiver, new IntentFilter(HomeActivity.ACTION_HOMEACTIVITY_EXIT));
		}
