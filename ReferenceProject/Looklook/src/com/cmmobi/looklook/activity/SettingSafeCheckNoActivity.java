	...
	*/
	...
	public void onClick(View v) {
		...
		case R.id.btn_newcheckno:
			ZDialog.show(R.layout.progressdialog, false, true, this);
			Requester2.getCheckNo(handler, phonenum, LoginSettingManager.GET_CHECK_NO_PHONE_SEC);
			break;
		}
	}
