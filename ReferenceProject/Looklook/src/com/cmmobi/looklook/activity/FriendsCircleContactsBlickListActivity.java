...
public class FriendsCircleContactsBlickListActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		backButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				FriendsCircleContactsBlickListActivity.this.finish();
			}
		});
		FriendsCircleContactsBlacklistFragment fragment = new FriendsCircleContactsBlacklistFragment();
