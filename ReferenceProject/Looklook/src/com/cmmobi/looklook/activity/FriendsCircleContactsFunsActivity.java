...
public class FriendsCircleContactsFunsActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		backButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				FriendsCircleContactsFunsActivity.this.finish();
			}
		});
		FriendsCircleContactsFunsFragment fragment = new FriendsCircleContactsFunsFragment();
