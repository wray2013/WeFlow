...
public class LoginPasswordDialog extends ZActivity {
	...
	public boolean handleMessage(Message msg) {
		...
		case Requester2.RESPONSE_TYPE_FORGET_PASSWORD:
			try {
				ZDialog.dismiss();
				GsonResponse2.forgetPasswordResponse obj = (GsonResponse2.forgetPasswordResponse) (msg.obj);
			    if(obj!=null){
	...
	public void onClick(View v) {
		...
		case R.id.btn_login_looklook_password_ok:
			...
			if(Prompt.checkEmail(username)){
				...
				Requester2.requestForgetPassword(getHandler(), username, "1", "1");
			}else if(Prompt.checkPhoneNum(username)){
				send_type = 2;
				ZDialog.show(R.layout.progressdialog, false, true, this);
				Requester2.requestForgetPassword(getHandler(), username, "2", "1");
			}else{
				send_type = 0;
				Prompt.Dialog(LoginPasswordDialog.this, false, "错误", "请输入合法的手机号或邮箱", null);
