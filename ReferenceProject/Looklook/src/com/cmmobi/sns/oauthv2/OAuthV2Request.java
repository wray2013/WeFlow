...
import com.weibo.sdk.android.api.RequestAPI;
...
public class OAuthV2Request implements RequestAPI {
    ...
    public String getResource(String url, WeiboParameters paramsList, OAuth oAuth)
            throws Exception {
        ...
        OAuthV2 oAuthV2 = (OAuthV2) oAuth;
        paramsList.add("access_token", oAuthV2.getAccessToken());
        String queryString = QStrOperate.encodeParameters(paramsList);
        return qHttpClient.httpGet(url, queryString);
    }
...
//        log.info("RequestAPI postContent queryString = " + queryString);
    ...
    public String postContent(String url,  WeiboParameters paramsList, OAuth oAuth)
            throws Exception {
...
//        log.info("RequestAPI postContent queryString = " + queryString);
	...
	@Override
	public String postFile(String url, WeiboParameters paramsList,
			List<NameValuePair> files, OAuth oAuth) throws Exception {
