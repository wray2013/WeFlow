...
public class AccessTokenKeeper {
	...
	public static GsonResponse2.MyBind tmp = null;
	/**
	...
	public static void keepAccessToken(Context context, OAuthV2 oAuth, int curWeiboIndex) {
		...
		GsonResponse2.MyBind a = new GsonResponse2.MyBind(curWeiboIndex, oAuth);
	...
	public static OAuthV2 readAccessToken(Context context, int curWeiboIndex){
		  ...
		  if(AA.isLogin()){
			 //登录状态, 直接在AccountInfo中更新
			  ...
			  GsonResponse2.MyBind at = AccountInfo.getInstance(AA.getUID()).readAccessToken("3", "3", type);
			  if(at!=null){
				  oAuth = new OAuthV2();
