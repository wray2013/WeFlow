...
public class TWTAPI extends BasicAPI{
     ...
     */
    public TWTAPI(String OAuthVersion) {
        super(OAuthVersion);
    }
     ...
     */
    public TWTAPI(String OAuthVersion, QHttpClient qHttpClient) {
	 ...
	 */
	public String show(OAuthV2 oAuth, String format, String id) throws Exception {
	 ...
	 */
	public String add(OAuthV2 oAuth, String format, String content,
	 ...
	 */
	public String del(OAuthV2 oAuth, String format, String id) throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", format));
		paramsList.add(new BasicNameValuePair("id", id));
	 ...
	 */
	public String reAdd(OAuthV2 oAuth, String format, String content,
	 ...
	 */
	public String comment(OAuthV2 oAuth, String format, String content,
			String clientip, String reid) throws Exception {
	 ...
	 */
	public String reply(OAuthV2 oAuth, String format, String content,
			String clientip, String reid) throws Exception {
	 ...
	 */
	public String addPic(OAuthV2 oAuth, String format, String content,
	 ...
	 */
	public String reCount(OAuthV2 oAuth, String format, String ids, String flag)
			throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", format));
	 ...
	 */
	public String reList(OAuthV2 oAuth, String format, String flag,String rootid,
	...
	public String addVideo(
			OAuthV2 oAuth, String format, String content,
