...
public class MonthView extends LinearLayout {
  ...
  public void init(MonthDescriptor month, List<List<MonthCellDescriptor>> cells,
    ...
    if (month.isCurrentMonth()) {
    	title.setBackgroundResource(R.drawable.calendar_title_bg_selected);
    } else {
    	title.setBackgroundResource(R.drawable.calendar_title_bg);
    }
    ...
    for (int i = 0; i < 6; i++) {
      ...
      if (i < numRows) {
        ...
        for (int c = 0; c < week.size(); c++) {
          ...
          cellView.setPadding(DisplayUtil.getSize(cellView.getContext(), 6), 0, 0, 0);
          cellView.setSelectable(cell.isSelectable());
          cellView.setSelected(cell.isSelected());
          cellView.setCurrentMonth(cell.isCurrentMonth());
          cellView.setToday(cell.isToday());
          cellView.setPriceStr(cell.getPrice());
