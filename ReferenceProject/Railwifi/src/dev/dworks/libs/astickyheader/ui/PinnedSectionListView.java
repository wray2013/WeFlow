...
import com.cmmobi.railwifi.BuildConfig;
	...
	public void initShadow(boolean visible) {
		if (visible) {
			if (mShadowDrawable == null) {
				mShadowDrawable = new GradientDrawable(Orientation.TOP_BOTTOM, new int[] { Color.parseColor("#60000000"), Color.parseColor("#20000000"), Color.parseColor("#00000000") });
...
//		Log.d("=AAA=","PinnedSectionListView createPinnedShadow");
...
//		pinnedView.setBackgroundColor(Color.WHITE);
		getPinnedAdapter().updateTop(pinnedView);
