...
public class SimpleSectionedListAdapter extends BaseAdapter implements PinnedSectionListAdapter{
    ...
    public SimpleSectionedListAdapter(Context context, BaseAdapter baseAdapter, int sectionResourceId, int headerTextViewResId, int headerImageViewResId) {
	...
	@Override
	public void updateTop(View topView) {
		// TODO Auto-generated method stub
		if (currentTopView != null && currentTopView != topView) {
			currentTopView.findViewById(mHeaderImageViewResId).setBackgroundResource(R.drawable.icon_time);
		}
		currentTopView = topView;
		currentTopView.findViewById(mHeaderImageViewResId).setBackgroundResource(R.drawable.icon_time_selected);
	}
}